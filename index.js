...
const comp = createPaddle(canvas.width - paddleWidth, canvas.height / 2 - paddleHeight / 2, paddleWidth, paddleHeight, "WHITE");
...
function render() {
    ...
    drawText(comp.score, (3 * canvas.width) / 4, canvas.height / 2, "GRAY", 120, 'bold');
